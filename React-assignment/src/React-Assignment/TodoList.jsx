              ...
              >
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="px-3 py-1 text-sm bg-yellow-500 text-black rounded hover:bg-yellow-600 transition-colors"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => this.onDeleteTask(todo.id)}
                    className="px-3 py-1 text-sm bg-red-500 text-black rounded hover:bg-red-600 transition-colors"
                  >
                    Delete
                  </button>
                </div>
